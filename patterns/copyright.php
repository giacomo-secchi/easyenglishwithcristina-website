...
<!-- wp:group {"backgroundColor":"base","layout":{"type":"constrained"},"fontSize":"tiny"} -->
<div class="wp-block-group has-base-background-color has-background has-tiny-font-size">
