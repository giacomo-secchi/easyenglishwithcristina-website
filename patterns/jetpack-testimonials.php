...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide">
        ...
        <p class="has-text-align-center has-secondary-color has-text-color has-link-color has-small-font-size" style="text-transform:uppercase"><?php echo esc_html_x( 'Testimonials', 'easyenglishwithcristina' ); ?></p>
        <!-- /wp:paragraph -->
        ...
        <h2 class="wp-block-heading alignwide has-text-align-center has-primary-color has-text-color has-link-color" style="margin-top:0;margin-bottom:0"><?php echo esc_html_x( 'Cosa pensano i nostri clienti di noi', 'easyenglishwithcristina' ); ?></h2>
        <!-- /wp:heading -->
    </div>
    <!-- /wp:group -->
